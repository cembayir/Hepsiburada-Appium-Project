...
public class StepImplementation extends BaseTest {
    ...
    private void swipeDownAccordingToPhoneSize() {
    }
    ...
    public void chooseRandomProduct(String key) {
        ...
        List<MobileElement> elements = appiumDriver.findElements(By.id(key));
    ...
    @Step("<xpath> xpath'li elementin oldugu kontrol edilir")
    public void checkElementxpath(String element){
